  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">書籍を検索して自動入力</label>
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={searching}
            className="px-4 py-2.5 bg-slate-100 dark:bg-slate-700 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
          >
        ...
        <button
          ...
          disabled={searching}
          className="sm:hidden w-full flex items-center justify-center gap-2 py-2.5 border border-indigo-200 dark:border-indigo-700 text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/50 rounded-xl text-sm font-medium hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors"
        >
